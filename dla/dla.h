...
#define DLA_GLOBAL_AVG_POOL_SEL_POS 16
#define DLA_GLOBAL_AVG_POOL_SEL_Msk (0x1 << DLA_GLOBAL_AVG_POOL_SEL_POS)


#define DLA_IS_BUSY_POS 1
#define DLA_IS_BUSY_Msk (0x27 << DLA_IS_BUSY_POS)
...
#define MOBILENET_S00_AXI_SLV_SHIFT_OFFSET              36
